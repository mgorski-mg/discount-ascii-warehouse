...
class AsciiItemRecyclerViewAdapter(private val list: List<AsciiItem>, context: Context) : RecyclerView.Adapter<AsciiItemRecyclerViewAdapter.BindingViewHolder>() {
